        ...
        VStack {
            VStack(alignment: .leading) {
                ...
                ScrollView(.horizontal) {
                    HStack(spacing: 20) {
                        CustomButton(searchProperties: $searchProperties, text: "Free", width: 50, height: 5)
                        CustomButton(searchProperties: $searchProperties, text: "Today", width: 60, height: 5)
                        CustomButton(searchProperties: $searchProperties, text: "Near", width: 60, height: 5)
                    }
